              ...
              children: List.generate(4, (index) {
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color:
                          isCodeWrong ? Color(0xFFD73F2C) : Color(0xFFC3C9C0),
                      width: 1,
                    ),
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      counterText:
                          "", // Removes the character counter below the input
                    ),
                    onChanged: (value) {
                      ...
                      setState(() {
                        ...
                        if (currentCode.length < 4) {
                          currentCode = List.generate(
                              4,
                              (i) =>
                                  i < currentCode.length ? currentCode[i] : "");
                        }
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      isCodeVerified ? Color(0xFF53634F) : Color(0xFFE5E8E3),
