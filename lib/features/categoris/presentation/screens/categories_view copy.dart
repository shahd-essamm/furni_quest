...
class CategoriesViewCopy extends StatefulWidget {
  const CategoriesViewCopy({super.key});

  @override
  State<CategoriesViewCopy> createState() => _CategoriesViewStateCopy();
}

class _CategoriesViewStateCopy extends State<CategoriesViewCopy> {
