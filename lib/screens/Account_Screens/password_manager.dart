          ...
          children: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: _isValid ? const Color(0xFF53634F) : const Color(0xFFE5E8E3),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
              borderSide: BorderSide(
                color: isError ? const Color(0xFFFDA29B) : const Color(0xFFA7B2A3),
              ),
            ),
            suffixIcon: IconButton(
              icon: Icon(
                isError && isConfirm ? Icons.error_outline : Icons.visibility_off_outlined,
                size: 24,
                color: isError && isConfirm ? const Color(0xFFD73F2C) : const Color(0xFF657660),
              ),
              onPressed: onToggle,
            ),
            hintText: '••••••••',
            hintStyle: TextStyle(
              ...
              fontSize: 14,
              color: isFilled ? const Color(0xFF3A3E39) : const Color(0xFF667085),
              fontFamily: 'Heebo',
            ),
          ),
        ),
