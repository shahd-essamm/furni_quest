...
import 'package:furni_quest/screens/Home_Screens/checkout_bank.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Center( // Title centered
          child: Text(
            "My Cart",
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Color(0xFF3A3E39)),
          ),
        ),
                    ...
                    builder: (context) {
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text("Remove from Cart?", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Color(0xFF2D352B))),
                            SizedBox(height: 10),
                            Image.asset(item['image'], height: 50),
                            SizedBox(height: 10),
                            Text(item['title'], style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xFF232922))),
                            ...
                            Row(
                              ...
                              children: [
                                TextButton(
                                  ...
                                  child: Text("Cancel", style: TextStyle(color: Color(0xFF657660))),
                                ),
                                ElevatedButton(
    ...
    return Row(
      ...
      children: [
        ...
        Container(
          ...
          child: Center( // Centering the minus icon
            child: IconButton(
        ...
        Text("${item['quantity']}", style: TextStyle(fontSize: 18, color: Color(0xFF3A3E39))),
        SizedBox(width: 8), // Space between the buttons
  ...
  Widget _buildSummaryRow(String title, int value, {bool isBold = false}) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(title, style: TextStyle(fontSize: 16, fontWeight: isBold ? FontWeight.bold : FontWeight.normal, color: Color(0xFF3A4537))),
          Text("\$${value}", style: TextStyle(fontSize: 16, fontWeight: isBold ? FontWeight.bold : FontWeight.normal, color: Color(0xFF2D352B))),
        ],
      ),
    );
  }
