...
class SearchChairScreen extends StatefulWidget {
  @override
  _SearchChairScreenState createState() => _SearchChairScreenState();
}

class _SearchChairScreenState extends State<SearchChairScreen> {
          ...
          Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(name, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, fontFamily: 'Heebo', color: Color(0xFF515E4D))),
              ),
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Row(children: List.generate(5, (index) => Icon(index < rating ? Icons.star : Icons.star_border, size: 14, color: Colors.amber))),
                    Text(price, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, fontFamily: 'Heebo', color: Color(0xFF232922))),
                  ],
                ),
              ),
            ],
