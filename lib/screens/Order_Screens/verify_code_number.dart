...
class _VerifyCodeNumberState extends State<VerifyCodeNumber> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      resizeToAvoidBottomInset: false, // يمنع تغيير ارتفاع الشاشة عند ظهور الكيبورد
      appBar: AppBar(
        backgroundColor: Colors.white,
        elevation: 0,
        leading: IconButton(
      ...
      body: SafeArea(
        child: GestureDetector(
          onTap: () => FocusScope.of(context).unfocus(), // إغلاق الكيبورد عند النقر خارج الإدخال
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontWeight: FontWeight.w600,
                          fontSize: 16,
                          color: isCodeVerified? Colors.white : Color(0xFF889584),
                        ),
                      ),
                    ),
                  ),
                  SizedBox(height: 16),
                  SizedBox(height: MediaQuery.of(context).viewInsets.bottom), // يجعل الزر مرئيًا عند ظهور الكيبورد
                ],
              ),
            ),
          ),
